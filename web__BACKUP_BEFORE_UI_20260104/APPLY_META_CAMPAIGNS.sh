...
echo "== Backup campaigns page =="
cp -f src/app/dashboard/campaigns/page.tsx "src/app/dashboard/campaigns/page.tsx.bak.$(date +%Y%m%d-%H%M%S)" || true

mkdir -p components/dashboard-meta

echo "== Create Meta Campaigns UI component =="
cat > components/dashboard-meta/CampaignsTable.tsx <<'EOF'
"use client";
...
echo "== Replace campaigns page with Meta-like layout =="
cat > src/app/dashboard/campaigns/page.tsx <<'EOF'
